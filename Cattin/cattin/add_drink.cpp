#include "add_drink.h"
#include "ui_add_drink.h"

add_drink::add_drink(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::add_drink)
{
    ui->setupUi(this);
...
void add_drink::on_configureBt_clicked()
{
        QSqlQuery query(db);
        char str[100];
        ...
        QString name = ui->drinkname_Edit->text();//饮品名
...
void add_drink::on_cancelBt_clicked()
{
    close();
}
